    ...
    <div x-data="{ activeInvoiceTab: 'customer-info' }" wire:ignore.self id="slideover-invoice-container" class="fixed inset-0 w-full h-full invisible z-50">
        ...
        <div wire:ignore.self id="slideover-invoice" class="absolute duration-500 ease-out transition-all h-full bg-white right-0 top-0 translate-x-full overflow-y-scroll md:w-full w-[390px] dark:bg-gray-900 {{ $memoTransfer ? 'ring-4 ring-inset ring-amber-400' : '' }}" >
            ...
            <div wire:loading.delay.long class="fixed z-50">
                ...
                <div wire:ignore.self x-data="{flex: 1}" x-show="activeInvoiceTab === 'customer-info'" class="p-4 rounded-lg dark:bg-gray-800" id="customer-info" role="tabpanel" aria-labelledby="customer-info-tab">
                    <form>
                ...
                <div wire:ignore.self x-cloak x-show="activeInvoiceTab === 'payments'" class="rounded-lg dark:bg-gray-800" id="payments" role="tabpanel" aria-labelledby="payments-tab">
                    @if ($invoice)
...
@script
    <script>
        $(function() {
            ...
            window.scrollInvoiceToTop = function() {
                $('#slideover-invoice').stop(true).animate({ scrollTop: 0 }, 900);
            }
