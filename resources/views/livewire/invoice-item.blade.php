...
@endpush
    ...
    <div x-data wire:ignore.self id="slideover-invoice-container" class="fixed inset-0 w-full h-full invisible z-50">
        ...
        <div wire:ignore.self id="slideover-invoice" class="absolute duration-500 ease-out transition-all h-full bg-white right-0 top-0 translate-x-full overflow-y-scroll md:w-full w-[390px] dark:bg-gray-900" >
            ...
            <div id="slideover-invoice-child" class="p-2 flex items-center shadow-sm rounded-full justify-center hover:bg-gray-300 cursor-pointer absolute top-0 right-0 m-2">
            ...
            <div wire:loading.delay.long class="fixed z-50">
                ...
                <div wire:ignore.self x-data="{flex: 1}" class="p-4 rounded-lg dark:bg-gray-800" id="customer-info" role="tabpanel" aria-labelledby="customer-info-tab">
                    <form>
                        ...
                        <div id="img_loader" class="absolute bg-gray-50 border border-gray-color border-solid h-50 overflow-y-auto p-1.5 shadow-lg hidden z-10">
                            <ul class="w-100 bg-white list-group">
                                @foreach ($this->productImages as $images)
                                    {!!$images !!}
                                @endforeach
                            </ul>
                        </div>

                        <div x-data="{creditAmount: @entangle('creditAmount')}" :class="creditAmount==0 ? 'hidden' : 'block'" class="bg-gray-800 fixed items-center justify-center m-1 p-2 left-1/2 -translate-x-1/2 top-0 rounded-lg text-lg text-red-400 z-10">This customer has a credit of {{'$'. number_format($creditAmount,2)}}</div>
                            ...
                            <table wire:ignore.self class="w-full text-sm text-left rtl:text-right dark:text-gray-400">
                                <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                    <tr>
                                        ...
                                        <th scope="col" class="px-4 py-3">Retail</th>
                                ...
                                <tr data-product-id="{{$item['id']}}" class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                        ...
                                        <td class="px-4 py-4"><img class="imgItem" style='width: 80px' src="{{ $item['image'] }}" /></td>
                                        <td class="px-4 py-4">
                                            <div class="flex justify-between relative">
                                                <input class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" wire:model="items.{{$index}}.product_name" type="text">
                                                @if (!empty($item['isReturned']))
                                                    <span class="-top-2 absolute bg-red-500 mr-1 p-0.5 right-0 rounded text-white text-xs pt-0">{{$item['isReturned']}}</span>
                                                @endif
                                            </div>
                                        </td>
                                        ...
                                        <td class="px-4 py-4">
                                            <input wire:model.live="items.{{$index}}.cost" data-id="{{ $item['id'] }}" data-name="cost" id="cost-{{ $index }}" type="text" style="width: 80px" placeholder="0.00" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" pattern="^\d*(\.\d{0,2})?$">
                                        ...
                                        <td class="px-4 py-4">
                                            @if ($item['serial'] == "N/A")
                                                <input wire:model.lazy="items.{{$index}}.serial" type="text" class="serial-input bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Serial" />
                                            @else
                                                {{ $item['serial'] }}
                                            @endif
                                        </td>
                                ...
                                <tr class="odd:bg-white odd:dark:bg-gray-900 even:bg-gray-50 even:dark:bg-gray-800 border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-4"><input type="text" wire:model.lazy="newProductId" placeholder="Serial" class="serial-input bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" type="text" /></td>
                            ...
                            <div class="pt-4">
                                ...
                                <div class="grid gap-2 mb-2 md:grid-cols-3">
                                    ...
                                    <div class="flex pb-2.5 items-center">
                                        <label class="block text-sm font-medium text-gray-900 dark:text-white w-32">Return Amount</label>
                                        <span class="text-right bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 text-red-500 font-medium">
                                            {{ $returnAmount ? ($returnAmount < 0 ? "(".number_format(abs($returnAmount),2).")" : $returnAmount) : '$0.00' }}
                                        </span>
                                    </div>
                                </div>
                                @endif
                                <div class="grid gap-2 mb-2 md:grid-cols-3">
                                    ...
                                    <div class="flex pb-2.5 items-center">
                                        ...
                                        <input id="freight" wire:model.live="customer.freight" class="text-right bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    </div>
                                </div>
                                <div class="grid gap-2 mb-2 md:grid-cols-3">
                                    <div></div>
                                    ...
                                    <div class="flex pb-2.5 items-center">
                                        ...
                                        <input id="discount" wire:model.live="customer.discount" class="text-right bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                                    </div>
                                </div>
                        ...
                        <div class="md:flex md:gap-6">
                            <div class="md:w-1/2 pt-3">
                                <div id="billing-collapse" data-accordion="open" >
                                    <h2 id="accordion-collapse-heading-3">
                                        <button type="button" class="dark:bg-gray-600 flex items-center justify-between md:bg-gray-100 rounded-t-xl w-full p-5 font-medium rtl:text-right text-gray-500 border border-gray-200 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3" data-accordion-target="#accordion-collapse-body-3" aria-expanded="false" aria-controls="accordion-collapse-body-3">
                                    ...
                                    <div id="accordion-collapse-body-3" class=" md:block" aria-labelledby="accordion-collapse-heading-3">
                            ...
                            <div class="md:w-1/2 pt-3">
                                <div id="shipping-collapse" data-accordion="open" >
                                    ...
                                    <div id="accordion-collapse-body-2" class=" md:block" aria-labelledby="accordion-collapse-heading-2">
                        ...
                        <div>
                            ...
                            <button type="button" wire:click="sendInvoice()" id="send-invoice" class="float-right text-white mt-4 bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800">Print Invoice</button>
                            <button type="button" id="print-invoice" class="float-right text-white mt-4 bg-darkred mr-2 hover:bg-red-500 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800">Send Invoice</button>
                ...
                <div wire:ignore.self class="hidden rounded-lg dark:bg-gray-800" id="payments" role="tabpanel" aria-labelledby="payments-tab">
                    ...
                    <table x-ref="table" class="w-full text-sm text-left rtl:text-right dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            <td class="align-baseline px-4 py-4">
                                @if ($creditAmount)
                                <button type="button" title="Use available credit" wire:click.prevent="setCreditAmountAndRef" class="rounded align-middle border-solid ease-in-out duration-300 border border-gray-600 p-1 hover:bg-gray-200" aria-label="Left Align">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v12m-3-2.818.879.659c1.171.879 3.07.879 4.242 0 1.172-.879 1.172-2.303 0-3.182C13.536 12.219 12.768 12 12 12c-.725 0-1.45-.22-2.003-.659-1.106-.879-1.106-2.303 0-3.182s2.9-.879 4.006 0l.415.33M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                                    </svg>
                                </button>
                                @endif
                                <button type="button" title="Set full amount of the amount owed" wire:click.prevent="$set('paymentAmount',{{$totalLeft}})" class="rounded align-middle border-solid ease-in-out duration-300 border border-gray-600 p-1 hover:bg-gray-200" aria-label="Left Align">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 17.25v3.375c0 .621-.504 1.125-1.125 1.125h-9.75a1.125 1.125 0 0 1-1.125-1.125V7.875c0-.621.504-1.125 1.125-1.125H6.75a9.06 9.06 0 0 1 1.5.124m7.5 10.376h3.375c.621 0 1.125-.504 1.125-1.125V11.25c0-4.46-3.243-8.161-7.5-8.876a9.06 9.06 0 0 0-1.5-.124H9.375c-.621 0-1.125.504-1.125 1.125v3.5m7.5 10.375H9.375a1.125 1.125 0 0 1-1.125-1.125v-9.25m12 6.625v-1.875a3.375 3.375 0 0 0-3.375-3.375h-1.5a1.125 1.125 0 0 1-1.125-1.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H9.75" />
                                    </svg>
                                </button>
                                <button type="button" title="Apply payment" class="rounded align-middle border-solid ease-in-out duration-300	border border-gray-600 p-1 hover:bg-gray-200" wire:click.prevent="savePayment({{$totalLeft}})" aria-label="Left Align">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                    ...
                    <tr>
                        ...
                        <td class="align-baseline px-4 py-4">
                            @if ($creditAmount)
                            <button type="button" wire:click.prevent="setCreditAmountAndRef" class="rounded align-middle border-solid ease-in-out duration-300 border border-gray-600 p-1 hover:bg-gray-200" aria-label="Left Align">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 17.25v3.375c0 .621-.504 1.125-1.125 1.125h-9.75a1.125 1.125 0 0 1-1.125-1.125V7.875c0-.621.504-1.125 1.125-1.125H6.75a9.06 9.06 0 0 1 1.5.124m7.5 10.376h3.375c.621 0 1.125-.504 1.125-1.125V11.25c0-4.46-3.243-8.161-7.5-8.876a9.06 9.06 0 0 0-1.5-.124H9.375c-.621 0-1.125.504-1.125 1.125v3.5m7.5 10.375H9.375a1.125 1.125 0 0 1-1.125-1.125v-9.25m12 6.625v-1.875a3.375 3.375 0 0 0-3.375-3.375h-1.5a1.125 1.125 0 0 1-1.125-1.125v-1.5a3.375 3.375 0 0 0-3.375-3.375H9.75" />
                            </svg>
                            </button>
        ...
        $(function() {
            ...
            $('#b_firstname').devbridgeAutocomplete({
                ...
                onSelect: function (suggestion) {
                    $wire.$call('setCustomerInfo', suggestion)
            ...
            $(document).on('click', '.imgItem', function(e) {
                ...
                const containerScrollTop = container.scrollTop(); // <<< add this!

                const row = button.closest("tr"); // or any container you want
                const productId = row.data("product-id");

                menu.data("product-id", productId);
                menu.data("row", row);
                ...
                if (spaceBelow >= menuHeight || spaceBelow > spaceAbove) {
                    topPosition = buttonOffset.top + buttonHeight + 5 - containerOffset + containerScrollTop;
                } else {
                    topPosition = buttonOffset.top - menuHeight - 5 - containerOffset + containerScrollTop;
                }
