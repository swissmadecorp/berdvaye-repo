<div>
    <div wire:ignore.self class="flex justify-center">
        <div x-data="{currentpage: @entangle('currentPage')}" class="container p-5">
            ...
            @if($products)
                ...
                <div :class="{'md:flex gap-6 items-start': currentpage === 2}">
                    ...
                    @elseif ($currentPage === 3) 
                        ...
                        <div class="md:flex gap-6 mt-6">
                            ...
                            <!-- wire transfer -->
                            @if ($paymentOption == 2)
                            <div class="bg-gray-50 border p-3 rounded-xs">
                            ...
                            @else
                            <!-- credit card -->
                            <div class="bg-gray-50 border p-3 rounded-xs" id="payment" >
                        ...
                        <div class="flex justify-end pt-4">
                            <button wire:click.prevent="PreviousStep()" class="text-white bg-gray-800 hover:bg-gray-900 focus:outline-hidden focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">
                                <i class="fas fa-angle-double-left"></i>
                                Previous Page
                            </button>
                            <button wire:click.prevent="OrderConfirmation()" class="text-white bg-gray-800 hover:bg-gray-900 focus:outline-hidden focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">
                                Order confirmation
                    ...
                    @elseif ($currentPage === 4)
                        ...
                        <div class="bg-gray-50 gap-[12rem] items-start md:flex p-2 rounded-md w-full">
                            <div>
                                ...
                                <?php } ?>
                                {{ $customer['b_phone'] }}<br>
                                {{ $customer['b_city'] }}, {{ $countries->getStateByCode($selectedState) }} {{ $customer['b_zip'] }}<br>
                ...
                <!-- Buttons -->
                @if ($currentPage === 1)    
                    <button wire:click.prevent="NextStep()" class="text-white bg-gray-800 hover:bg-gray-900 focus:outline-hidden focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">Checkout
                        <i class="fas fa-angle-double-right"></i>
                    </button>
                @elseif ($currentPage === 2)
                    <div class="flex justify-end pt-4">
                        ...
                        <button wire:click.prevent="NextStep()" class="text-white bg-gray-800 hover:bg-gray-900 focus:outline-hidden focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">Continue to Payment
                            <i class="fas fa-angle-double-right"></i>
                        </button>
                    </div>
                @elseif ($currentPage === 4)
                    <div class="flex justify-end pt-4">
                        ...
                        <button wire:click.prevent="finalizePurchase()" class="text-white bg-gray-800 hover:bg-gray-900 focus:outline-hidden focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">
                            Finalize your Order
                        </button>
                    </div>
                @endif
    ...
    @else
        <h4 class="p-[150px] text-2xl text-center">Your cart is empty.</h4>
    </div>
    @endif
