                ...
                <tbody>
                    @foreach($customers as $customer)
                        <tr wire:key="{{$customer->id}}"
                            ...
                            <td class="px-3 py-2.5"><a href="" wire:click.prevent="invokeCustomerId({{$customer->id}},'{{$customer->company}}')" class="editcustomer">{{$customer->id}}</a></td>
                            <td class="px-3 py-2.5">{{ ($customer->company) ? $customer->company : $customer->firstname . ' ' . $customer->lastname }}</td>
