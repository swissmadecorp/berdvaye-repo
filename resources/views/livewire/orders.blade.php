        ...
        <table x-data = "{status: @entangle('status'), darkMode: true}" class="w-full text-sm text-left rtl:text-right dark:text-white-400">
            ...
            <tfoot>
                <tr class="font-semibold text-gray-900 dark:text-white">
                    <th colspan="4" scope="row" class="px-3 py-3 text-base">Total</th>
                    <td colspan="2" class="font-semibold px-3 py-3 text-right text-lg text-red-800 dark:text-red-300">${{number_format($totalcost,2)}}</td>
                </tr>
            </tfoot>
        </table>
    </div>
