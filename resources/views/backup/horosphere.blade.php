...
<div class="pageLayout"> 
  ...
  <main>
    <div class="defaultBanner">
      <img src="images/product/product_01/hero_banner/hb_00.jpg" alt="hb_00" class="w-100"/>
        ...
        <div class="row clearfix">
          <div class="col-12 col-sm-6">
            <div class="defaultBox-img float-right">
              <div class="defaultimg"><img src="images/product/product_01/product_img_01.jpg" alt="Horosphere"/></div>
              <div class="defaultimg leftImg"><img src="images/product/product_01/product_img_00.jpg" alt="Horosphere"/></div>
            </div>
          </div>
          <div class="col-12 col-sm-6">
            <div class="defaultBox-info animateRun" data-vp-add-class="visible" data-vp-repeat="false" data-vp-offset="12%">
              <h2>Horosphere</h2>
              <p class="pt-3 pb-3">A spherical globe embracing both fluidity and precision; an exacting orb which allows the eye a 360° vantage point to the thousands of watch components housed within.</p>
              <div class="productBox">
                <div class="productBox-size"> <a href="#" class="active" data-parts="3,000-3,500" data-other="6 lbs. &amp;&nbsp; 6x6x6" data-id='sps'>Small</a> <a href="#" data-parts="4,000-4,500" data-other="21 lbs. &nbsp;&amp;&nbsp; 9.5x9.5x9.5" data-id='spl'>Large</a> </div>
                <p class="productBox-qty">Limited edition: 999 pieces</p>
                <p class="productBox-part callParts">Number of Parts: 3,000-3,500</p>
                <p class="productBox-part callSize">Weight & Dimensions: <span>6 lbs. &amp;&nbsp; 6x6x6</span> <small>Inches</small></p>
                @include ('addtocart',['data'=>'variation','model'=>'sps'])</div>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="productThumb animateRun" data-vp-add-class="visible" data-vp-repeat="false" data-vp-offset="12%">
      <div class="container clearfix">
        <ul>
          <li><img src="images/product/product_01/thumb/thumb_01.jpg" alt="thumb_01"></li>
          <li><img src="images/product/product_01/thumb/thumb_02.jpg" alt="thumb_02"></li>
          <li><img src="images/product/product_01/thumb/thumb_03.jpg" alt="thumb_03"></li>
        </ul>
      </div>
    </div>
    <div class="productBanner animateRun" data-vp-add-class="visible" data-vp-repeat="false" data-vp-offset="12%">
      <div class="container clearfix">
        <div id="productBanner" class="owl-carousel owl-theme ownCarousel">
          <div class="item">
            <div class="productBanner-Box"> <img class="owl-lazy" data-src="images/product/product_01/banners/banner_01.jpg" alt="banner_01"/>
          ...
          <div class="item">
            <div class="productBanner-Box"> <img class="owl-lazy" data-src="images/product/product_01/banners/banner_02.jpg" alt="banner_02"/>
              <div class="productBanner-info">
                <h2>02</h2>
          ...
          <div class="item">
            <div class="productBanner-Box"> <img class="owl-lazy" data-src="images/product/product_01/banners/banner_03.jpg" alt="banner_03"/>
              <div class="productBanner-info">
                <h2>03</h2>
                <p>Our sculptures are the perfect compliment to your personal library. Like your most prized volumes, each crystal clear Lucite&trade; design piece holds within it the varied stories and histories of the passage of time.</p>
              </div>
            </div>
          </div>
        </div>
