      ...
      <div class="container-fluid">
        <div class="row clearfix justify-content-center">
          <div class="col-12 col-sm-10 col-md-8">
            <h2>Authorized <span>Dealers</span></h2>
      ...
      <div class="container">
        <div class="row clearfix">
          ...
          <div class="col-12 col-sm-6 col-md-6 col-lg-4">
            <div class="dealerBox">
              <h3 class="dealerBox-name">{{$dealer->customer}}</h3>
              <p class="dealerBox-loc"><b><img src="public/images/contact/icon_loc.png" alt="icon_loc"></b>{!! nl2br($dealer->address) !!}</p>
              <p class="dealerBox-tel"><b><img src="public/images/contact/icon_call.png" alt="icon_call"></b>{{$dealer->phone}}</p>
              <p class="dealerBox-site"><b><img src="public/images/contact/icon_site.png" alt="icon_site"></b><a href="{{$dealer->website}}" target="_blank">{{$dealer->website}}</a></p>
            </div>
          </div>
          @endforeach
        </div>
...
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBuu5S5S2I8ORvtF1VMJVdslJDSDzfgM6Q&callback=initMap"
...
<script type="text/javascript">
    ...
    function initMap() {
        ...
        var searchUrl = "{{action('GoogleMarkersController@ajaxGoogleMarkers')}}";
        var stores = '';
    ...
    function searchLocationsNear(center) {
         ...
         var radius = 10;
         var searchUrl = "{{action('GoogleMarkersController@ajaxGetByGoogleMarker')}}" + '/?lat=' + center.lat() + '&lng=' + center.lng() + '&radius=' + radius;
         downloadUrl(searchUrl, function(data) {
