...
<form method="POST" action="{{route('orders.update',[$order->id])}}" accept-charset="UTF-8" id="orderFrom">
@csrf
@method('PATCH')
    ...
    <div class="col-md-6 order-group billing" >
        ...
        <div class="p-1">
            ...
            <div class="form-group row lastname">
                ...
                <div class="col-9 input-group">
                    <input autocomplete="off" id="b_lastname-input" class="typeahead form-control" name="b_lastname" type="text" value="{{$order->b_lastname}}">
                </div>
            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-9 input-group">
                    <input id="b_email-input" class="form-control" name="email" type="text" value="{{$order->b_email}}">
                </div>
            </div>
        </div>
    </div>
...
<table class="table order-products table-striped table-bordered">
    ...
    <tbody>
        ...
        <tr>
            <td>{{$product->id}}</td>
            <td>
                <img style="width: 70px" class="tblimg" src="{{ '/images/thumbs/'.$image }}" />
...
<div class="form-group row">
    <div class="col-12">
        ...
        <input name="tracking" id="tracking-input" class="form-control" type="text" value="{{$order->tracking}}">
    </div>
</div>

<div class="form-group row">
    <div class="col-12">
        <label for="tracking-input" class="col-form-label">Additional Information (seen by customers)</label>
        <textarea type="text" name="add_info" rows="5" id="add_info-input" class="form-control">{{ $order->add_info }}</textarea>
    </div>
</div>
...
<script>
    ...
    $(document).ready( function() {
        ...
        stateFromCountry('#b_country',"{{$order->b_state}}");
        stateFromCountry('#s_country',"{{$order->s_state}}");
                        ...
                        $.ajax({
                            ...
                            success: function (result) {
                                if (result) {
                                    ...
                                    tr.find('td:eq(2)').children('input').attr('disabled',false);
