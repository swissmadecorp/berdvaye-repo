...
@section ('content')
 ...
 {{  Form::model($supplier, array('route' => array('suppliers.update', $supplier->id), 'method' => 'PATCH', 'id' => 'supplierform')) }} 
    ...
    <div class="form-group row">
        ...
        <div class="col-9 input-group">
            <input class="form-control" value="<?php echo !empty($supplier->phone) ? $supplier->phone : '' ?>" type="text" placeholder="Enter phone number" name="phone" id="phone-input" required>
        </div>
    </div>    
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-9">
            <input class="form-control" value="<?php echo !empty($supplier->contact) ? $supplier->contact : '' ?>" type="text" placeholder="Enter contact name" name="contact" id="contact-input" required>
        </div>
    </div>    
    <div class="form-group row">
        <label for="email-input" class="col-3 col-form-label">Email</label>
        <div class="col-9">
            <input class="form-control" value="<?php echo !empty($supplier->email) ? $supplier->email : '' ?>" type="text" placeholder="Enter email address" name="email" id="email-input" required>
        </div>
    </div>
