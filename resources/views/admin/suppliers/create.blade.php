...
{{  Form::open(array('action'=>'SuppliersController@store')) }}  
    <div class="form-group row">
        ...
        <div class="col-9">
            <input class="form-control" value="<?php echo !empty(old('firstname')) ? old('firstname') : '' ?>" type="text" name="firstname" id="firstname-input" required>
        </div>
    </div>
    <div class="form-group row">
    ...
    <div class="form-group row">
        ...
        <div class="col-9">
            <input class="form-control" placeholder="Enter contact name" value="<?php echo !empty(old('contact')) ? old('contact') : '' ?>" type="text" name="contact" id="contact-input" required>
        </div>
    </div>
    <div class="form-group row">
        <label for="email-input" class="col-3 col-form-label">Email</label>
        <div class="col-9">
            <input class="form-control" value="<?php echo !empty(old('email')) ? old('email') : '' ?>" type="text" name="email" id="email-input" required>
        </div>
    </div>
