        ...
        <div class="col-9">
            ...
            <div class="image-container">
                <div class="image">
                    ...
                    <img class="form-control" src="/public/images/posts/thumbs/<?php echo $post->image ?>" type="text" placeholder="Enter new image name" name="image" id="image-name-input" />
                </div>
            </div>
...
<script>
    ...
    $(document).ready( function() {
        ...
        $('.delete-image').click( function() {
            ...
            var request = $.ajax({
                type: "POST",
                url: "{{route('delete.image.from.post')}}",
                data: { 
                    _token: "{{csrf_token()}}",
                    post_id: "{{ $post->id }}"
                },
