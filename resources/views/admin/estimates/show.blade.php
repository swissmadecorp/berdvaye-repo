...
<div class="form-group row">
    <div class="col-6">
        ...
        <span class="form-control" name="po-input">{!! $estimate->po ? $estimate->po : "&nbsp;" !!}</span>
    </div>    
    <div class="col-6">
        <label for="payment-input" class="col-form-label">Payment Method</label>
        @if ($estimate->method == 'On Memo')
...
<div class="order-group billing" style="margin-right: 8px;margin-bottom: 8px;">
    ...
    <div class="p-1">
        ...
        <div class="form-group row">
            ...
            <div class="col-9 input-group">
                <span class="form-control">{{ $countries->getStateFromCountry($estimate->b_state) }}</span>
            </div>
        </div>
        <div class="form-group row">
...
<div class="order-group shipping">
    ...
    <div class="p-1">
        ...
        <div class="form-group row">
            <label for="b-state-input" class="col-3 col-form-label">State</label>
            <div class="col-9 input-group">
                <span class="form-control">{{ $countries->getStateFromCountry($estimate->s_state) }}</span>
            </div>
        </div>
        <div class="form-group row">
            <label for="b-city-input" class="col-3 col-form-label">City</label>
        ...
        <div class="form-group row">
            ...
            <div class="col-9 input-group">
                <span class="form-control">{{ $estimate->email }}</span>
            </div>
        </div>
    </div>
</div>
<table class="table estimate-products">
    ...
    <tbody>
        ...
        <tr>
            <td><img style="width: 80px" src="/images/thumbs/{{ $product->retail->image_location }}" />
                <input type="hidden" name="p_model" value="{{$product->retail->p_model}}">
            </td>
            <td>
                {{ $product->product_name }}
                @if ($estimate->b_company == 'Website' && $product->stock==0)
                    <br><span style="color:red">item currently not in stock</span>
                @endif
            </td>
    ...
    <tfoot>
        ...
        @endif
        <tr>
            <td style="text-align: right" colspan="4"><b>Freight</b>
            @if ($estimate->ship_method)
            ({{$estimate->ship_method}})
            @endif
            </td>
