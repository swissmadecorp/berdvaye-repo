...
function initVisitorTracker(root) {
    ...
    const visitorStorageKey = 'berdvaye_visitor_key';
    const sessionStorageKey = 'berdvaye_visitor_session_token';
    const leaveRecordKey = 'berdvaye_visitor_leave_record';
    ...
    const cookieParts = [
        `berdvaye_visitor_key=${visitorKey}`,
        'path=/',
        'max-age=31536000',
        'SameSite=Lax',
    ];
    ...
    function patchHistoryMethod(name) {
        ...
        window.history[name] = function patchedHistoryMethod(...args) {
            ...
            window.dispatchEvent(new Event('berdvaye:locationchange'));
    ...
    window.addEventListener('berdvaye:locationchange', heartbeatIfPageChanged);
