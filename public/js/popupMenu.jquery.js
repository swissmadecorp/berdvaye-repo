(function($) {
    ...
    $.fn.popupMenu = function(options) {
        ...
        if (settings.buttonSelector) {
            // DELEGATION MODE: Best for Livewire. Works on all future elements matching the selector.
            $(document).off("click.popupMenu", settings.buttonSelector)
                       .on("click.popupMenu", settings.buttonSelector, function(e) {
                handleButtonClick(e, settings);
            });
        } else {
            // DIRECT BINDING MODE: Binds only to current elements.
            // Warning: Will break if Livewire replaces these elements.
            $elements.off("click.popupMenu").on("click.popupMenu", function(e) {
                handleButtonClick(e, settings);
            });
        }
